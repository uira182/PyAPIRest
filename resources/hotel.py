...
# path /hoteis?cidade=Rio_de_Janeiro&estrelas_min=4$diaria_max=400
...
class Hotel(Resource):
    ...
    argumentos.add_argument('nome', type=str, required=True,
                            help="The fild 'nome' cannot be left clear")
    ...
    def post(self, hotel_id):
        ...
        if not SiteModel.find_by_id(dados['site_id']):
            return {'message': 'The hotel must be associted to a valid site id.'}, 400
